...
class AWSSDKCredentialProvider extends AWSTemporaryCredentialProvider {
    ...
    get provider() {
        ...
        let { AWS_STS_REGIONAL_ENDPOINTS = '', AWS_REGION = '' } = process***REMOVED***;
    ...
    async getCredentials() {
         ...
         *
         * - Environment variables exposed via process***REMOVED***
...
class LegacyAWSTemporaryCredentialProvider extends AWSTemporaryCredentialProvider {
    async getCredentials() {
        ...
        if (process***REMOVED***.AWS_CONTAINER_CREDENTIALS_RELATIVE_URI) {
            return await (0, utils_1.request)(`${AWS_RELATIVE_URI}${process***REMOVED***.AWS_CONTAINER_CREDENTIALS_RELATIVE_URI}`);
        }
