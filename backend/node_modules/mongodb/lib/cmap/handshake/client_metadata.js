...
async function getContainerMetadata() {
    ...
    const { KUBERNETES_SERVICE_HOST = '' } = process***REMOVED***;
...
async function addContainerMetadata(originalMetadata) {
    ...
    const extendedEnvMetadata = { ...originalMetadata?***REMOVED***, container: containerMetadata };
 ...
 */
function getFAASEnv() {
    const { AWS_EXECUTION_ENV = '', AWS_LAMBDA_RUNTIME_API = '', FUNCTIONS_WORKER_RUNTIME = '', K_SERVICE = '', FUNCTION_NAME = '', VERCEL = '', AWS_LAMBDA_FUNCTION_MEMORY_SIZE = '', AWS_REGION = '', FUNCTION_MEMORY_MB = '', FUNCTION_REGION = '', FUNCTION_TIMEOUT_SEC = '', VERCEL_REGION = '' } = process***REMOVED***;
