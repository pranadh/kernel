...
export function parseOptions(
  ...
  if (mongoOptions[loggerFeatureFlag]) {
    loggerEnvOptions = {
      MONGODB_LOG_COMMAND: process***REMOVED***.MONGODB_LOG_COMMAND,
      MONGODB_LOG_TOPOLOGY: process***REMOVED***.MONGODB_LOG_TOPOLOGY,
      MONGODB_LOG_SERVER_SELECTION: process***REMOVED***.MONGODB_LOG_SERVER_SELECTION,
      MONGODB_LOG_CONNECTION: process***REMOVED***.MONGODB_LOG_CONNECTION,
      MONGODB_LOG_CLIENT: process***REMOVED***.MONGODB_LOG_CLIENT,
      MONGODB_LOG_ALL: process***REMOVED***.MONGODB_LOG_ALL,
      MONGODB_LOG_MAX_DOCUMENT_LENGTH: process***REMOVED***.MONGODB_LOG_MAX_DOCUMENT_LENGTH,
      MONGODB_LOG_PATH: process***REMOVED***.MONGODB_LOG_PATH,
