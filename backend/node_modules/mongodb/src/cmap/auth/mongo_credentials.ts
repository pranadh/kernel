...
export class MongoCredentials {
  ...
  constructor(options: MongoCredentialsOptions) {
    ...
    if (this.mechanism.match(/MONGODB-AWS/i)) {
      if (!this.username && process***REMOVED***.AWS_ACCESS_KEY_ID) {
        this.username = process***REMOVED***.AWS_ACCESS_KEY_ID;
      }

      if (!this.password && process***REMOVED***.AWS_SECRET_ACCESS_KEY) {
        this.password = process***REMOVED***.AWS_SECRET_ACCESS_KEY;
      }

      if (
        this.mechanismProperties.AWS_SESSION_TOKEN == null &&
        process***REMOVED***.AWS_SESSION_TOKEN != null
      ) {
        this.mechanismProperties = {
          ...this.mechanismProperties,
          AWS_SESSION_TOKEN: process***REMOVED***.AWS_SESSION_TOKEN
        };
      }
    }
